...
from btc_prediction.features import app
...
@patch("btc_prediction.features.logger")
@patch("btc_prediction.features.tqdm")
def test_logging_and_progress_called(mock_tqdm, mock_logger):
    ...
    mock_logger.info.assert_any_call("Generating features from dataset...")
    mock_logger.info.assert_any_call("Something happened for iteration 5.")
    mock_logger.success.assert_called_once_with("Features generation complete.")
